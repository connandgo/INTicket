...
function seed() {
  const mk = (id, title, category, price, count, desc) => ({
    id, title, description: desc, category, price,
  ...
  return {
    ...
    enrollments: [],
    seq: { user: 10, course: 100, enrollment: 1000 }
  }
}
